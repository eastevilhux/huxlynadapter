package com.huxlyn.regret.commons;
...
public class RecycleGridDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecycleGridDivider(Context context, int dividerWidth, boolean isNeedSpace) {
     ...
     */
    public RecycleGridDivider(Context context, int dividerWidth, int firstRowTopMargin, boolean isNeedSpace) {
     ...
     */
    public RecycleGridDivider(Context context, int dividerWidth, int firstRowTopMargin, boolean isNeedSpace, boolean isLastRowNeedSpace) {
     ...
     * @param isLastRowNeedSpace 最后一行是否需要间隔
     */
    public RecycleGridDivider(Context context, int dividerWidth,
                              int firstRowTopMargin, boolean isNeedSpace, boolean isLastRowNeedSpace, @ColorInt int color) {
